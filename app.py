...
@st.cache_resource
def load_my_model():
    # Esta línea debe tener indentación porque pertenece a la función
...
if canvas_result.image_data is not None:
    # TODO LO QUE SIGUE debe tener indentación porque depende del "if" superior
    
    # Convertir el dibujo a 28x28 píxeles (formato MNIST) arreglado en una línea
